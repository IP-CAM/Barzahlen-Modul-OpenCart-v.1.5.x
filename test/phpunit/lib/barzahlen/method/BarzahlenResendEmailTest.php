...
class BarzahlenResendEmailTest extends PHPUnit_Framework_TestCase
{
    private $apiFactory;
    ...
    public function setUp()
    {
        ...
        $this->requestFactory = $this->getMock("BarzahlenRequestFactory", array("createResendEmailRequest"), array(), "", false);
        $this->api = $this->getMock("Barzahlen_Api", array("setDebug", "handleRequest"), array(), "", false);
        $this->request = $this->getMock("Barzahlen_Request_Resend", array(), array(), "", false);
        ...
        $this->requestFactory
            ->expects($this->any())
            ->method("createResendEmailRequest")
    ...
    {
        return new BarzahlenResendEmail($this->apiFactory, $this->requestFactory);
    }
    ...
    public function testRequestWillBeSentToBarzahlenApi()
    {
        ...
        $createRefund->resend($this->transactionId, $this->config);
    }
}
