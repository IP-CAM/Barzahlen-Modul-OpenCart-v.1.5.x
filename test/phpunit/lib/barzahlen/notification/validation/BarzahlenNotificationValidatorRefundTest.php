...
/**
 * Barzahlen Refund Module for OpenCart
...
class BarzahlenNotificationValidatorRefundTest extends PHPUnit_Framework_TestCase
{
    private $statusMap;
    private $shopId;
    private $orderId;
    ...
    protected function setUp()
    {
        ...
        $this->data = array(
            'shop_id' => $this->shopId,
            'origin_order_id' => $this->orderId,
            'origin_transaction_id' => $this->transactionId,
        );
    }

    private function createNotificationValidator()
    {
        return new BarzahlenNotificationValidatorRefund($this->statusMap);
    }
