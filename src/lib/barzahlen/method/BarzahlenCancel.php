...
/**
 * Cancel a transaction via the Barzahlen API
 */
class BarzahlenCancel
{
    /**
     ...
     * @param array $config
     */
    public function cancel($transactionId, $config)
    {
        $request = $this->barzahlenRequestFactory->createCancelRequest($transactionId);
